...
# }
override_doctype_class = {
    "Delivery Note": "custom_app.overrides.delivery_note_validation.DeliveryNoteValidation",
    "Sales Invoice": "custom_app.overrides.sales_invoice_validation.SalesInvoiceValidation"
}
# Document Events
# ---------------
...
fixtures = [
    ...
    {"dt": "DocType", "filters": [["module", "=", "Custom App"]]},
    {
        "dt": "Stock Entry Type",
        "filters": {
            "name": ["in", ["Service Inward", "Product Dispatch", "Product Inward"]]
        }
    },
    {
        "dt":"Role",
        "filters": {
            "is_custom": 1,
            "name": ["not in", ["Employee Self Service"]]
        }
    },
    {
        "dt":"Workflow State",
